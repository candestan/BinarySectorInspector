...
* PyInstaller — CArchive cookie/TOC/PYZ inventory (`packer.pyinstaller.generic`; empty gates + MEI probe)
...
Identity JSON: `compiler.labview.generic`, `packer.labview.generic`, `packer.pyinstaller.generic`. Interactive RSRC graph UI remains in the DecompBeaker plugin.
